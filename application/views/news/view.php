<table border='1' cellpadding='4'>     
    ...
    <tr>             
		...
		<td><a href="<?php echo site_url('news/edit/'.$news_item['nim']); ?>">Edit</a> | <a href="<?php echo site_url('news/delete/'.$news_item['nim']); ?>" onClick="return confirm('Apa kamu yakin menghapus data ini?')">Hapus</a> </td>
	</tr> 
	<?php 
		endforeach; 
